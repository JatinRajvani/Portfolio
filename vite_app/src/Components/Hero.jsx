  ...
  return (
    <div className="flex flex-col justify-center lg:justify-start items-center lg:items-start gap-4 min-h-[80vh] sm:min-h-[90vh] px-6 sm:px-10 md:px-12 text-white font-sans text-center lg:text-left">
      ...
      <p className="text-sm sm:text-base md:text-lg text-gray-100 italic max-w-2xl mb-5 sm:mb-6 leading-relaxed drop-shadow-sm">
        Turning <span className="text-[var(--color-accent)] font-medium">"it'll never work"</span> into{' '}
        <span className="text-[var(--color-accent)] font-medium">"wait, that was too easy."</span>
        <br />
      ...
      <div className="flex flex-wrap justify-center lg:justify-start gap-4 mb-5">
        <button className="bg-[var(--color-accent)] hover:opacity-90 text-white font-medium py-2.5 px-5 text-sm rounded-md transition-all duration-300 shadow hover:shadow-lg hover:-translate-y-1">
          View Projects
        </button>
        <button className="border border-[var(--color-accent)] hover:bg-[var(--color-accent)] text-white hover:text-white font-medium py-2 px-5 text-sm rounded-md transition-all duration-300 shadow hover:shadow-lg hover:-translate-y-1">
          About Me
        </button>
      </div>
      ...
      <div className="flex justify-center lg:justify-start gap-5 pb-8 sm:pb-0">
        {[
          ...
          <a
            ...
            className="text-xl sm:text-2xl hover:text-[var(--color-accent)] transition-transform transform hover:rotate-[360deg] duration-500"
          >
            {item.icon}
          </a>
        ))}
