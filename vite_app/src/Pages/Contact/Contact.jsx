...
export default function ContactMe() {
  ...
  const contactInfo = [
    {
      ...
      label: "Email",
      value: "jatinrajvani.cg@gmail.com",
      link: "mailto:jatinrajvani.cg@gmail.com"
    },
    // {
    //   icon: (
    //     <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const socialLinks = [
    {
      name: "LinkedIn",
      link: "https://www.linkedin.com/in/jatin-rajvani/",
      icon: (
    ...
    {
      name: "LeetCode",
      link: "https://leetcode.com/u/JatinRajvani/",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    // {
    //   name: "Instagram",
    //   link: "https://instagram.com/rajvanijatin",
    //   icon: (
    //     <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
