          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            {[
              ...
              >
                ...
                <p className="text-gray-300 text-sm leading-relaxed">{item.info}</p>
              </div>
            ))}
          </div>
        </div>
...
{/* <div className="mb-12">
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
    ...
    <div className="p-6 bg-gray-900 border border-gray-700 rounded-xl text-center hover:border-[#FDC700] transition-all">
      ...
      <h3 className="text-lg font-semibold text-[#FDC700] mb-2">LinkedIn</h3>
      <a
    ...
    <div className="p-6 bg-gray-900 border border-gray-700 rounded-xl text-center hover:border-[#FDC700] transition-all">
      ...
      <h3 className="text-lg font-semibold text-[#FDC700] mb-2">X (Twitter)</h3>
      <a
    ...
    <div className="p-6 bg-gray-900 border border-gray-700 rounded-xl text-center hover:border-[#FDC700] transition-all">
      ...
      <h3 className="text-lg font-semibold text-[#FDC700] mb-2">GitHub</h3>
      <a
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
            ...
            <div className="bg-gray-900 p-6 sm:p-8 rounded-xl border border-gray-700 shadow-lg">
              ...
              <form className="space-y-5">
                ...
                ></textarea>
                <button className="w-full py-3 bg-[#FDC700] text-black font-semibold rounded-md hover:bg-yellow-400 transition text-sm sm:text-base">
                  Send Message
                </button>
              </form>
            </div>
